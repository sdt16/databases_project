...
class book_edit_form(Form):
    ...
    currency = SelectField("Currency", choices=[(g,g) for g in ['USD', 'EUR', 'GBP', 'CAD', 'CNY', 'JPY']])
    ...
    territory = SelectField("Countries to sell in", choices=[('US', 'US'), ('GB', 'GB'), ('FR', 'FR'), ('IT', 'IT'), ('CN', 'CN'), ('JP', 'JP'), ('ES', 'ES'), ('IE', 'IE'), ('DE', 'DE')], validators=[Optional()])
    adult = BooleanField("Is this an adult book?")
    edition = TextField("Edition")
    #TODO: Fix series to not be ID
